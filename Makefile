######################################################################
# Copyright 2006 University of British Columbia and Derek Poon
# Copyright 2006, 2014 The University of British Columbia and Derek Poon
# Released under the Mozilla Public License, v2.0.
#
#
# GNU Makefile for RT Search extension.  For a fancier Makefile, see
